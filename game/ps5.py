...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
    ...
    while condition:
        ...
        while (not is_valid) and (user_input != "."): 
            user_input = raw_input('Invalid input, choose another word: ')
            is_valid = is_valid_word(user_input, hand, word_list)
        if user_input == ".":
            break
        ...
        print user_input + ' earned ' + str(score) + ' points. Total: ' + str(tot) + ' points ' 
    print 'Total score: ' + str(tot) + ' points.'  # replace this with your code...
